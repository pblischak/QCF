...
print "\n\nThis script is from the TICR pipeline.\n";
print "Please be sure to cite the original TICR paper if you use it:\n\n";

print "  Stenz, N. W. M., B. Larget, D. A. Baum, and C. Ane. 2015.\n";
print "  Exploring Tree-Like and Non-Tree-Like Patterns Using Genome Sequences:\n";
print "  An Example Using the Inbreeding Plant Species Arabidopsis thaliana (L.) Heynh.\n";
print "  Systematic Biology 64:809--823.\n\n";

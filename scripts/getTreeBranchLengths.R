...
cat("Please be sure to cite the original TICR paper if you use it:\n\n")

cat("  Stenz, N. W. M., B. Larget, D. A. Baum, and C. Ane. 2015.\n")
cat("  Exploring Tree-Like and Non-Tree-Like Patterns Using Genome Sequences:\n")
cat("  An Example Using the Inbreeding Plant Species Arabidopsis thaliana (L.) Heynh.\n")
cat("  Systematic Biology 64:809--823.\n\n")
